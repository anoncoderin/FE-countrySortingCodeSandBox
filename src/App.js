...
function filter(list, option) {
  if (option === "all") {
    ...
    return list.filter((e) => e.population >= 100000000);
  } else if (option === "200m") {
    return list.filter((e) => e.poputation >= 200000000);
  } else if (option === "500") {
    return list.filter((e) => e.population >= 500000000);
  } else if (option === "1B") {
    return list.filter((e) => e.population >= 1000000000);
  } else
